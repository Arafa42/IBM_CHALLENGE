...
public class WindEnergyYear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wind_energy_year);
        ...
        current.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(WindEnergyYear.this, wind_energie_chart.class);
                startActivity(i);
            }
        });
        ...
        week.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(WindEnergyYear.this, WindEnergyWeek.class);
                startActivity(i);
            }
        });
        ...
        year.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(WindEnergyYear.this, WindEnergyYear.class);
                startActivity(i);
            }
        });
        ...
        bestelEnergy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(WindEnergyYear.this, ReserveMenu.class);
                startActivity(i);
            }
        });


        dbref = FirebaseDatabase.getInstance().getReference().child("yearAheadWind");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                series.setOnDataPointTapListener(new OnDataPointTapListener() {
                    ...
                    public void onTap(Series series, DataPointInterface dataPoint) {
                        ...
                        Toast.makeText(WindEnergyYear.this, msg, Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                graphView.setTitle("Wind Energy Year Ahead");
