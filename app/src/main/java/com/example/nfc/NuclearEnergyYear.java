...
public class NuclearEnergyYear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nuclear_energy_year);
        ...
        current.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(NuclearEnergyYear.this, nuclear_energie_chart.class);
                startActivity(i);
            }
        });
        ...
        week.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(NuclearEnergyYear.this, NuclearEnergyWeek.class);
                startActivity(i);
            }
        });
        ...
        year.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(NuclearEnergyYear.this, NuclearEnergyYear.class);
                startActivity(i);
            }
        });
        ...
        bestelEnergy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(NuclearEnergyYear.this, ReserveMenu.class);
                startActivity(i);
            }
        });


        dbref = FirebaseDatabase.getInstance().getReference().child("yearAheadNuclear");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                series.setOnDataPointTapListener(new OnDataPointTapListener() {
                    ...
                    public void onTap(Series series, DataPointInterface dataPoint) {
                        ...
                        Toast.makeText(NuclearEnergyYear.this, msg, Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                graphView.setTitle("Nuclear Energy Year Ahead");
