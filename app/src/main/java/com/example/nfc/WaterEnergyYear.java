...
public class WaterEnergyYear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_water_energy_year);
        ...
        current.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(WaterEnergyYear.this, water_energie_chart.class);
                startActivity(i);
            }
        });
        ...
        week.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(WaterEnergyYear.this, WaterEnergyWeek.class);
                startActivity(i);
            }
        });
        ...
        year.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(WaterEnergyYear.this, WaterEnergyYear.class);
                startActivity(i);
            }
        });
        ...
        bestelEnergy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(WaterEnergyYear.this, ReserveMenu.class);
                startActivity(i);
            }
        });


        dbref = FirebaseDatabase.getInstance().getReference().child("yearAheadWater");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                series.setOnDataPointTapListener(new OnDataPointTapListener() {
                    ...
                    public void onTap(Series series, DataPointInterface dataPoint) {
                        ...
                        Toast.makeText(WaterEnergyYear.this, msg, Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                graphView.setTitle("Water Energy Year Ahead");
